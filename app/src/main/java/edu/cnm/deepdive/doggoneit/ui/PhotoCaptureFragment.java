...
import edu.cnm.deepdive.doggoneit.databinding.FragmentPhotoCaptureBinding;

@AndroidEntryPoint
public class PhotoCaptureFragment extends Fragment {

  private FragmentPhotoCaptureBinding binding;
  ...
  public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
    ...
    binding.analyzeButton.setOnClickListener(
        v -> NavHostFragment.findNavController(this)
            .navigate(R.id.action_photoCaptureFragment_to_scanAnalysisFragment));
  }
