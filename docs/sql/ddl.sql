-- Generated 2026-03-16 09:30:28-0600 for database version 1
...
(
    ...
    FOREIGN KEY (`breed_fact_id`) REFERENCES `breed_fact` (`breed_fact_id`) ON UPDATE NO ACTION ON DELETE SET NULL
);
